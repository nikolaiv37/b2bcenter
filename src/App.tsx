...
const WaybillsPage = lazy(() => import('@/app/dashboard/waybills').then((m) => ({ default: m.WaybillsPage })))
            ...
            <TenantProvider>
              <AppContextProvider>
                ...
                >
                  ...
                  <Route path="waybills" element={<Suspense fallback={<PageLoader />}><WaybillsPage /></Suspense>} />
